    ...
    <div style={{ background:BG, color:TEXT, minHeight:"100vh", fontFamily:"'DM Sans',system-ui,sans-serif", overflowX:"hidden" }}>
      <style>{`
        ...
        *{box-sizing:border-box;}
        ...
        .currency-toggle button{transition:all 0.2s;}
        ...
        <div className="hero-grid">
          <div>
            ...
            <h1 className="fade-up fade-up-1" style={{ fontFamily:"'DM Serif Display',serif", fontSize:"clamp(36px,5vw,60px)", lineHeight:1.08, letterSpacing:"-0.02em", color:TEXT, marginBottom:16 }}>
              Stop losing leads<br /><span style={{ fontStyle:"italic", color:ACCENT }}>to your voicemail.</span>
            </h1>
      ...
      <section id="pricing" className="section-pad" style={{ maxWidth:1100, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:48 }}>
          ...
          <div style={{ display:"flex", justifyContent:"center", marginTop:20 }}>
            <div className="currency-toggle" style={{ display:"inline-flex", background:SURFACE, border:`1px solid ${BORDER}`, borderRadius:24, padding:4 }}>
              {["USD","EUR"].map(c=>(
                <button key={c} onClick={()=>setCurrency(c)} style={{ padding:"6px 22px", borderRadius:20, border:"none", background:currency===c?ACCENT:"transparent", color:currency===c?"#fff":MUTED, fontSize:13, fontWeight:currency===c?600:400, cursor:"pointer", fontFamily:"inherit" }}>
                  {c==="USD"?"🇺🇸 USD":"🇪🇺 EUR"}
                </button>
              ))}
            </div>
